...
* @desc : 导入通用JS文件
*/
importJs(baseUrl+"/scripts/jquery.1.10.2.min.js");
importJs(baseUrl+"/crm/plugins/jquery.page.js");
importJs(baseUrl+"/startbootstrap/js/layer.js");

//importJs(baseUrl+"/scripts/lib/jquery/jquery-1.5.js");
/*importJs(baseUrl+"/crm/bootstrap/js/bootstrap.min.js");
importJs("https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js");
importJs(baseUrl+"/crm/plugins/morris/morris.min.js");
importJs(baseUrl+"/crm/plugins/fastclick/fastclick.js");
importJs(baseUrl+"/crm/dist/js/app.min.js");
importJs(baseUrl+"/crm/dist/js/demo.js");*/
/*
