 ...
 */
@Entity
@Table(name = "t_area_info_history")
public class AreaInfoHistory extends DataEntity {
	...
	public void setAreainfo_id(Long areainfo_id) {
