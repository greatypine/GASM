...
/**
 * Created by cyh(275923233@qq.com) on 2015/9/9.
 */
@Component
public class FileToDB {
    ...
    Logger logger = Logger.getLogger("DataToDB.class");

    public void exlToDB(String filePath, JdbcTemplate jdbcTemplate,Community community) {
        boolean flag = true;
        ...
        try {
            ...
            for (int i = 1; i <= totalRow; i++) {
                ...
                if (row.getCell(0) != null && !"".equals(row.getCell(0)) && row.getCell(1) != null && !"".equals(row.getCell(1))) {
                    ...
                    this.community.setProvinceid(community.getProvinceid());
                    this.community.setCityid(community.getCityid());
                    this.community.setTownid(community.getTownid());
