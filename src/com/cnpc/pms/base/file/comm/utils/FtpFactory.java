...
public class FtpFactory {
    ...
    public static void main(String[] args) throws Exception {
        String ftpPath = "ftp://10.16.0.100/piclib/excel/01-椿树街道 - 副本/02-地图/红线社区.png";
       // ftpPath = "ftp://10.16.0.100/piclib/excel/01-椿树街道 - 副本/01-数据/椿树街道-椿树园社区.xlsx";
        String localPath = "E:\\617\\Taurus\\target\\taurus\\download\\";
        String fileName = ftpPath.substring(ftpPath.lastIndexOf("/") + 1, ftpPath.length());
        String remotePath = "ftp://10.16.0.100/piclib/excel/01-椿树街道 - 副本/02-地图";
        remotePath = "piclib/excel/01-椿树街道 - 副本/02-地图";
//        new FtpFactory(FTPConstants.IP, FTPConstants.PORT, FTPConstants.USERNAME, FTPConstants.PWD)
//                .ftpDownZipFile(remotePath, fileName, localPath);
        new FtpFactory(FTPConstants.IP, FTPConstants.PORT, FTPConstants.USERNAME, FTPConstants.PWD)
                .ftpDownFile(remotePath, fileName, localPath);
       // ZipUtil.unZipFiles((localPath+fileName).replaceAll(".zip",""), localPath+fileName);
    }
}
