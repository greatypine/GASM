...
public class HikariGuoanInner {
    ...
    static{
        try {
            ...
            String connectionUrl = "jdbc:impala://" + "10.16.21.74" + ':' + "21050" + "/gabase;auth=noSasl";
    ...
    public static Connection getConnection(){
        ...
        Logger logger = LoggerFactory.getLogger(HikariGuoanInner.class);
