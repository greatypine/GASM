 ...
 * 
  ...
  * @date 2018年9月20日
 */
public class HikariGeminiInner {
	//定义 Hikari 连接池配置对象
    ...
    static{
        try {
            ...
            String connectionUrl = "jdbc:impala://" + impala_host + ':' + impala_port + "/gemini;auth=noSasl";
    ...
    public static Connection getConnection(){
        ...
        Logger logger = LoggerFactory.getLogger(HikariGeminiInner.class);
